...
function removeAmount(accountName, amount) {
  ...
  if (accountData.balance < amount) {
    console.log(chalk.bgRed.black('Você não tem este valor disponível!'));
...
function transfer() {
  inquirer
    ...
    .then((answer) => {
      ...
      if (!checkAccount(accountName) || !checkAccount(targetAccount)) {
        return transfer();
      }
      ...
      inquirer
        ...
        .then((answer) => {
          ...
          console.log(
            chalk.bgBlue.black(
              `Tranferência de ${accountName} de R$ ${amount} reais para ${targetAccount} realizada com sucesso!`
            )
          );
          operation();
        })
